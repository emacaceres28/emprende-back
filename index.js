const dotenv = require ('dotenv')// definimos una constante donde requerimos codigo del paquete dotenv
dotenv.config()
...
console.log({name});//imprime el nombre martin
...
const PORT = process.env.PORT //"PORT es una variable que suele existir en todos los entornos productivos"
